...
describe('updateConstants', () => {
  ...
  test('arrow dimensions', () => {
      ...
      expect(gantt.constants.DATE_GRADUATION_START).toEqual(350)
  ...
  test('fonts', () => {
      ...
      expect(gantt.constants.TASK_FONT_SIZE).toEqual(18)
      expect(gantt.constants.SUBTASK_FONT_SIZE).toEqual(14)
